...
*Figura 1: Serie con media constante (*$\mu = 50$) y ruido blanco ($\sigma = 5$).

#### 2. Tendencia Lineal con Ruido Blanco
...
*Figura 2: Serie con tendencia lineal (*$\beta = 2.5$) y ruido blanco ($\sigma = 10$).
